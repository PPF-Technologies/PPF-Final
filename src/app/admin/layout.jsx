        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <a href="/dashboard/home" className="flex ml-2 md:mr-24">
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li>
              <a href="#" className={`flex items-center p-2 text-gray-300 rounded-lg hover:bg-gray-700 group ${pathname === '/admin' ? 'bg-gray-700' : ''}`}>
            ...
            <li>
              <a href="/admin/home" className={`flex items-center p-2 text-gray-300 rounded-lg hover:bg-gray-700 group ${pathname === '/admin/home' ? 'bg-gray-700' : ''}`}>
            ...
            <li>
              <a href="/admin/contact-us" className={`flex items-center p-2 text-gray-300 rounded-lg hover:bg-gray-700 group ${pathname === '/admin/contact-us' ? 'bg-gray-700' : ''}`}>
            ...
            <li>
              <a href="/admin/retailers" className={`flex items-center p-2 text-gray-300 rounded-lg hover:bg-gray-700 group ${pathname === '/admin/retailers' ? 'bg-gray-700' : ''}`}>
            ...
            <li>
              <a href="/admin/inhouse-warranty" className={`flex items-center p-2 text-gray-300 rounded-lg hover:bg-gray-700 group ${pathname === '/admin/inhouse-warranty' ? 'bg-gray-700' : ''}`}>
            ...
            <li>
              <a href="/admin/retailer-warranty" className={`flex items-center p-2 text-gray-300 rounded-lg hover:bg-gray-700 group ${pathname === '/admin/retailer-warranty' ? 'bg-gray-700' : ''}`}>
                <svg className="flex-shrink-0 w-5 h-5 text-gray-400 transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
