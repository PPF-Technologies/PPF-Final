  ...
  return (
    ...
    >
      ...
      <Box textAlign="left" maxW={{ base: "100%", md: "600px" }} gap="30px">
        ...
        >
          At CAMIO, we believe that every vehicle deserves the best protection without compromising on aesthetics. Our passion for innovation and quality has driven us to develop a range of high-performance Paint Protection Films (PPF) that offer unparalleled durability, clarity, and protection. Trusted by car enthusiasts and professionals worldwide, CAMIO PPF is the ultimate shield for your vehicle’s finish.
        </Text>
